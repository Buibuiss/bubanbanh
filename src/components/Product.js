...
const Product = ({ product }) => {
    return (
        <Link to={`/product/${product.id}}`}>
            <div className="bg-gradient-to-bl from-pink-50 to-pink-300 w-full h-[362px] rounded-[8px] overflow-hidden relative group">
                ...
                <div className="px-6 pb-8 flex flex-col">
                    ...
                    <div className="text-lg text-accent">{product.attributes.price} Đ</div>
                </div>
            </div>
        </Link>
    );
